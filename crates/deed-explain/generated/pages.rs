// @generated by `cargo test -p deed-explain --test generated -- --ignored`.
...
pub static PAGES: &[Page] = &[
    ...
    Page {
        ...
        example: Some("module https://example.com/list.deed\n"),
        example_source: Some("crates/deed-driver/tests/manifest.rs"),
    },
    Page {
        code: "DEED7005",
    ...
    Page {
        ...
        example: Some("fn logs(n: Int) -> Int uses Log.note { Log.note(\"x\") n }\n\nfn quiet(n: Int) -> Int { n }\n\n"),
    ...
    Page {
        ...
        example: Some("handler InMemory implements Ledger {\n  state holdings: Int\n\n  fn balance(id) -> Int { holdings }\n}\n\ntest \"writes an audit note\" {\n  with InMemory { holdings: 1 } {\n    Audit.append(1)\n  }\n}\n"),
        example_source: Some("crates/deed-effects/tests/effects.rs"),
    },
    Page {
        code: "DEED5006",
    ...
    Page {
        ...
        example: Some("module a\n\neffect Ledger {\n    fn balance() -> Int\n}\n\nfn f() -> Int\n  uses\n    Ledger.balance,\n  ensures\n    ok  => Ledger.balance() == old(Ledger.balance()),\n    err => unchanged(Ledger),\n{\n  0\n}\n"),
        example_source: Some("crates/deed-driver/tests/fully_typed.rs"),
    },
    Page {
        code: "DEED6001",
    ...
    Page {
        ...
        example_source: Some("crates/deed-driver/tests/failures.rs"),
    },
    Page {
        code: "DEED6005",
        name: "NO_HANDLER",
        ...
        example: Some("module a\n\neffect Log {\nfn note(line: String) -> ()\n}\n\nfn main() -> Int\nuses\nLog.note,\n{\nLog.note(\"hi\")\n0\n}\n"),
        example_source: Some("crates/deed-driver/tests/host.rs"),
    },
    Page {
        code: "DEED6006",
        name: "NOT_RUNNABLE",
        ...
        example: Some("module a\n\nfn main(sys: System) -> ()\n  uses Io.write,\n{\n  Io.write(sys.clock, \"hi\")\n}\n"),
        example_source: Some("crates/deed-interp/tests/messages.rs"),
    },
    Page {
        code: "DEED6007",
        name: "ARITHMETIC",
    ...
    Page {
        ...
        example_source: Some("crates/deed-interp/tests/properties.rs"),
    },
    Page {
        code: "DEED6009",
        name: "TOO_DEEP",
    ...
    Page {
        ...
        example: Some("an effect got past the checker:\n{}"),
        example_source: Some("crates/deed-driver/tests/rows_at_runtime.rs"),
    },
    Page {
        code: "DEED6011",
        name: "ABANDONED",
    ...
    Page {
        ...
        example: Some("module threshold/walk\n\nfn over_text(line: String) -> Int {\n    for character in line with seen = 0 {\n        seen + 1\n    }\n}\n\ntest \"unreachable\" {\n    assert over_text(\"ab\") == 2\n}\n"),
    ...
    Page {
        ...
        example: Some("fn f(n: Int) -> Positive\n  where\n    n < 0,\n{\n    n\n}\n"),
    ...
    Page {
        ...
        example: Some("module a\n\nchoice Outcome<T, E> {\n    Good { value: T },\n    Bad { error: E },\n}\n\nfn or_else<T, E>(outcome: Outcome<T, E>, fallback: T) -> T {\n    match outcome {\n        Good { value } => value,\n        Bad { error } => fallback,\n    }\n}\n\ntest \"either side\" {\n  assert or_else(Good { value: \"yes\" }, \"no\") == \"yes\"\n  assert or_else(Bad { error: 404 }, \"no\") == \"no\"\n}\n"),
        example_source: Some("crates/deed-driver/tests/generic_types.rs"),
    },
    Page {
        code: "DEED4024",
    ...
    Page {
        ...
        example_source: Some("crates/deed-driver/tests/guards.rs"),
    },
    Page {
        code: "DEED4026",
