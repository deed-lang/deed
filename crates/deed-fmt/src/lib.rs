//! The one canonical form of a Deed source file.
//!
...
//! let file = sources.add("demo.deed", "module demo\nfn   f( n:Int )->Int{n+n}\n");
//! let formatted = deed_fmt::format(file, sources.file(file).text()).unwrap();
//! assert_eq!(formatted, "module demo\n\nfn f(n: Int) -> Int {\n    n + n\n}\n");
//! ```

mod printer;

use deed_diagnostics::{Diagnostic, FileId};
