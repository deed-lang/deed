...
//!
//! `VOW3003` says a name was imported and never used, and there is exactly one
...
//! and the replacement is what `vow fmt` would print for whatever is left.
//!
