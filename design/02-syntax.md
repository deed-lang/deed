...
`prepend`, `find`, `take`, `drop`, `concat`, `flatten`, `partition`, `zip`, `enumerate`, `windows`, `chunks`, `intersperse` and `unzip`. It was written long before there was anywhere to put it and sat under
