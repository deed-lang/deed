...
**What would change the answer now.** A contract that has to say something about a fractional quantity, which is the half of the original worry that writing the library never tested. The other half, arithmetic dense enough that named calls stop being readable, was answered without a number type.
