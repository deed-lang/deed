...
go to definition, type definition, implementation, references, document highlight, rename, formatting, code actions,
document symbol, folding range, selection range, document link, semantic tokens, completion, signature help and workspace symbol.
